  ...
  return (
    <div>
      <div className="container text-center pt-2">
        <h1 className="pt-2" style={{ color: "blue " }}>Contact Us</h1>
        <p style={{ color: "white" }}>
          Don’t let your questions go unanswered. Call on Jani motors. We
          can answer any questions that you may have about our vehicles, the car
