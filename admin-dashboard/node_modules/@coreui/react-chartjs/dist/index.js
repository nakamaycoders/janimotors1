...
var CChart = React.forwardRef(function (props, ref) {
    ...
    var canvas = function (ref) {
        return (React__default["default"].createElement("canvas", __assign({}, (!wrapper && className && { className: className }), { "data-testid": "canvas", height: height, id: id, onClick: function (e) {
                handleOnClick(e);
            }, ref: ref, role: "img", width: width }, rest), fallbackContent));
    };
    return wrapper ? (React__default["default"].createElement("div", __assign({ className: classNames('chart-wrapper', className) }, rest), canvas(canvasRef))) : (canvas(canvasRef));
});
CChart.propTypes = {
